...
export class BlockPreviewService {
     ...
     * @throws ApiError
     */
    public static previewGridMarkup(data: PreviewGridMarkupData = {}): CancelablePromise<PreviewGridMarkupResponse> {
     ...
     * @throws ApiError
     */
    public static previewListMarkup(data: PreviewListMarkupData = {}): CancelablePromise<PreviewListMarkupResponse> {
        return __request(OpenAPI, {
            method: 'POST',
